...
const Countdown = () => {
  ...
  return (
    <div className={`relative h-screen ${isNewYear ? "bg-yellow-400" : "bg-gradient-to-br from-purple-700 via-pink-500 to-yellow-300"} overflow-hidden`}>
      {/* Decorative Shapes */}
      ...
      <div className="flex flex-col items-center justify-center h-full text-white">
        {!isNewYear ? (
          <>
            <h1 className="text-5xl font-bold mb-6">Countdown to 2025</h1>
            <div className="text-3xl space-x-8 flex">
          ...
          <div className="flex flex-col items-center text-center">
            <h1 className="text-6xl font-extrabold mb-4">🎉 Happy New Year 2025! 🎉</h1>
